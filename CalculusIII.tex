%%%%
% June 5, 2015, CreateSpace ISBN created
% ISBN-13: 978-1514240908 
% 
% ISBN-10: 1514240904 
%%%%
...
% TG 2017-12-17 Added to temporarily reduce warnings
% Remove for final compilation.
\hbadness=10000
\hfuzz=\maxdimen
\newcount\hbadness
\newdimen\hfuzz
...
% TG 2017-12-18 Added to get more information about label changes
% Remove for final compilation.
 \def\@testdef #1#2#3{%
...
%\clearpage{\pagestyle{empty}\cleardoublepage}
%\thispagestyle{empty}
\setcounterref{definitioncounter}{lastdefcount2}
\addtocounter{definitioncounter}{-1}
\setcounterref{theoremcounter}{lastthmcount2}
\addtocounter{theoremcounter}{-1}
\setcounterref{keyideacounter}{lastideacount2}
\addtocounter{keyideacounter}{-1}
%\setcounterref{examplecounter}{lastexamplecount2}
...
%TG 2017-12-16 \addtocounter{chapter}{8}
%\clearpage{\pagestyle{empty}\cleardoublepage}
%\chapter{Curves in the Plane}
%\thispagestyle{empty}

%\setcounterpageref{page}{lastdefcount2}

%%%%def:\ref{lastdefcount2} thm:\ref{lastthmcount2} idea:\pageref{lastideacount2}
...
\addtocounter{chapter}{9} %uncommented TG 12-16-2017
\clearpage{\pagestyle{empty}\cleardoublepage}
\chapter{Vectors}
\thispagestyle{empty}
...
\input{text/12_Lagrange_Multipliers}
...
\input{text/13_Cylindrical}
\input{text/13_Spherical}

%%%\addtocounter{chapter}{12}
%
\clearpage{\pagestyle{empty}\cleardoublepage}
\chapter{Vector Calculus}\label{chapter:vec_calc}
\thispagestyle{empty}
...
\input{text/14_Divergence_Space}
\input{text/14_Stokes}
%\input{text/14_Vector_Fields_old}
%\input{text/14_Line_Integrals_old}
%\input{text/14_Greens_Theorem_old}
%\addtocontents{toc}{\protect\thispagestyle{empty}}
%\input{text/14_Surface_Integrals_old}
%\input{text/14_Divergence_Theorem_old}
%\input{text/14_Stokes_Curl_old}

%% This prints the exercise section
%
\appendix
