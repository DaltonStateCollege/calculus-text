...
\input{text/01_Infinite_Limits}
\input{text/01_Limits_At_Infinity}
...
%\addtocontents{toc}{\protect\thispagestyle{empty}} duplicate line?
...
\input{text/07_Center_of_Mass_CalcII}
...
\addtocontents{toc}{\protect\thispagestyle{empty}}%%%\addtocounter{chapter}{10}
\clearpage{\pagestyle{empty}\cleardoublepage}
...
%\input{text/13_Cylindrical_Spherical_old}
