{A standard region in space, as defined by spherical coordinates, is shown. Set up the triple integral that integrates $h(\rho,\theta,\varphi)$ over the graphed region.
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=150pt}{figures/fig13_07_ex_10}
}
