{ A standard region in space, as defined by cylindrical coordinates, is shown. Set up the triple integral that integrates $h(r,\theta,z)$ over the graphed region.
