{$C$ is the curve parameterized by $\vec r(t) = \langle \cos t, \sin t, 1\rangle$ and $\surfaceS$ is the portion of $z=x^2+y^2$ enclosed by $C$; $\vec F = \langle z,-x,y\rangle$. 
...
3Dlights=Headlamp,add3Djscript=asylabels.js}{width=90pt}{figures/fig14_07_ex_09}\hfill}
%
