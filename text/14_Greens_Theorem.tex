...
\mfigure[scale=0.4]{.3}{Ellipse}{fig:fig_greens_thm_ellipse}{figures/fig_greens_thm_ellipse}

\example{ex_greenstheorem2}{}{Using a line integral, compute the area of the ellipse
$$\dfrac{x^2}{a^2} + \dfrac{y^2}{b^2} = 1$$
with semiaxes of length $a$ and $b$.}{See Figure \ref{fig:fig_greens_thm_ellipse}.  By the above equation for the ellipse, we can parametrize the ellipse as
$$x = a \cos(t), \: \: y = b \sin(t)$$
