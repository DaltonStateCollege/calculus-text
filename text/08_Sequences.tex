...
Sequences are a great source of mathematical inquiry. The On-Line Encyclopedia of Integer Sequences (\url{http://oeis.org}) contains thousands of sequences with formulas when known. (As of this writing, there are 299,701 sequences in the database.  Not all sequences have a known formula.) Perusing this database quickly demonstrates that a single sequence can represent several different ``real life'' phenomena. 
