...
\example{ex_lagrange3}{}{The position vector at (x, y) is R = xi + yj. Its components are M = x
...
\example{ex_lagrange3}{}{}{ The vector field R/r consists of unit vectors u,, pointing outward. We
...
rejection of $\mathbf{S}$ and S/r will be interesting. For some reason -yi + xj is rejected and
