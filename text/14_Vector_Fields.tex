...
\mfigure[scale=0.5]{.7}{The vector field $\mathbf{S}$}{fig:fig_vec_fields_spin}{figures/fig_vec_fields_spin}

\mfigure[scale=0.5]{.5}{The vector field $\mathbf{S}/r$}{fig:fig_vec_fields_spin_over_r}{figures/fig_vec_fields_spin_over_r}

\mfigure[scale=0.5]{.3}{The vector field $\mathbf{S}/r^2$}{fig:fig_vec_fields_spin_over_r_squared}{figures/fig_vec_fields_spin_over_r_squared}
