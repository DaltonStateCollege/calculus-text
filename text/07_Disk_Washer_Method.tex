...
3Dcoo=60.78499984741211 0.48087620735168457 -14.641631126403809,
3Droo=150.00000157638937,
3Dlights=Headlamp,add3Djscript=asylabels.js}{}{.75}{Cutting a slice in the pyramid in Example \ref{ex_disk0} at $x=3$.}{fig:disk0a}{figures/figcross_area1a_3D}
...
V &= \pi\int_1^3 \Big((2x-1)^2-(x^2-2x+2)^2\Big)\ dx \\
		...
		&= \pi\left[-\frac{1}{5}x^5+x^4-\frac43x^3+2x^2-3x\right]\Big|_1^3 \\
...
\begin{itemize}
	...
	\item	then use limits to establish a definite integral which gives the exact value.%\vspace{-0.057 in}
\end{itemize}
