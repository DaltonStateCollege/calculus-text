...
\mfigure[scale=0.5]{.3}{$z=1-r$}{fig:fig_cylindrical_spherical_z_equals_1_minus_r}{figures/fig_cylindrical_spherical_z_equals_1_minus_r}
...
\mfigure[scale=0.5]{.6}{Solid $D$ bounded above by $z=2$, below by $z=1-x^2-y^2$, laterally by $x^2+y^2=1$}{fig:fig_cylindrical_spherical_mass_example}{figures/fig_cylindrical_spherical_mass_example}
...
\mfigure[scale=0.5]{.3}{Spherical coordinates $\rho \phi \theta$}{fig:fig_cylindrical_spherical_spherical}{figures/fig_cylindrical_spherical_spherical}
...
\mfigure[scale=0.5]{.3}{Spherical box}{fig:fig_cylindrical_spherical_spherical_box}{figures/fig_cylindrical_spherical_spherical_box}
