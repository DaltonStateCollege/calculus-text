...
\mfigure{.8}{The unit circle with its tangent line at $(1/2,\sqrt{3}/2)$.}{fig:implicit7}{figures/figimplicit7}
}\\
...
\mfigure{.575}{An astroid, traced out by a point on the smaller circle as it rolls inside the larger circle.}{fig:implicit9}{figures/figimplicit9}
...
\mfigure{.35}{An astroid with a tangent line.}{fig:implicit8}{figures/figimplicit8}
}\\
...
\frac{1}{y}\cdot\frac{dy}{dx} &= \ln x + x\cdot\frac1x\\
\frac{1}{y}\cdot\frac{dy}{dx} &= \ln x + 1\\
\frac{dy}{dx} &= \parbox{50pt}{$y\big(\ln x+1\big)$} \text{\small (substitute $y=x^x$)}\\
