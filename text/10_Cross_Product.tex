...
$$\crossp uv = \la (-1)5-(4)2,(4)3-(2)5, (2)2-(-1)3\ra = \la -13,2,7\ra.$$ 
...
\begin{enumerate}
	...
	\item	\begin{enumerate}
		\item \parbox{145pt}{$(\vec u\pm\vec v)\times \vecw = \crossp uw\pm \crossp vw$} Distributive Properties
		\item	$\vec u \times (\vec v\pm \vec w) = \crossp uv\pm \crossp uw$
	\end{enumerate}
	...
	\item		$\crossp u0 = \crossp 0u = \vec 0$
...
There is another equivalent way to use the right hand rule that some may find easier.  If you point your right thumb in the direction of $\vec u$ and the remaining fingers of your right hand in the direction of $\vec v$, then the palm side of your right hand will face in the direction of $\crossp uv$.
\vskip\baselineskip
...
{\begin{enumerate}
	...
	\begin{align*}
	\vec F = 10\la \cos-15^\circ,\sin-15^\circ\ra &= \la \frac{5\left(\sqrt{6} + \sqrt{2}\right)}{2},-\frac{5\left(\sqrt{6} - \sqrt{2}\right)}{2},0\ra \\
	&\approx \la 9.659,-2.588\ra.\end{align*}
	
	We again make the third component 0 and take the cross product to find the torque:
	\begin{align*}
	\vec\tau &= \crossp \ell F\\
					&= \la \sqrt2,\sqrt2,0\ra \times  \la \frac{5\left(\sqrt{6} + \sqrt{2}\right)}{2},-\frac{5\left(\sqrt{6} - \sqrt{2}\right)}{2},0\ra\\
					&= \la 0,0,-10\sqrt3\ra\\
