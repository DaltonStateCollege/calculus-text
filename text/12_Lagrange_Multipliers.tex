...
The winning point is $(x_{\text{min}},y_{\text{min}}) = \left( \frac{2}{5}k, \frac{1}{5}k \right)$.  It minimizes the distance squared $f = x^2 + y^2 = \frac{1}{5}k^2$ from the origin to the line.}
