...
2xz + 2yz + xy & = 20
\end{align}
Note that the first three equations imply that $\lambda \neq 0$, else one would arrive at the conclusion $xyz=0$, which does not make sense in this situation.  Therefore we can divide by $\lambda$ and we get from equations $(1)$ and $(2)$ that
$$2xz + xy = 2yz + xy \text{ or } xz = yz.$$
Since $z \neq 0$, we get that $x=y$.  Further, equations $(2)$ and $(3)$ imply that
