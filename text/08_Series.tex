...
\noindent 1. $\ds\sum_{n=1}^\infty \frac{(-1)^{n+1}\big(n^2-n\big)}{n^3}$\qquad 2. $\ds\sum_{n=1}^\infty \frac{1000}{n!}$\\3. $\ds \frac1{16}+\frac1{25}+\frac1{36}+\frac1{49}+\cdots$ \qquad 4. $\ds \sum_{n=1}^\infty \frac{n^2}{n!}$
}
{\begin{enumerate}
...
\item              We manipulate this series to look like the series that involves $e$ in Key Idea \ref{idea:famous_series}.  In the steps below, we twice change relabel $n$ as $n+1$.  Note that $n!=n(n-1)!$.
\begin{align*}
