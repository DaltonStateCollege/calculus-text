...
\iint_R (4-y)\ dA &= \int_0^4\int_{y^2/4}^{2\sqrt{y}}(4-y)\ dx\ dy\\
				...
				&= \int_0^4 \left(\left(2\sqrt{y}-\frac{y^2}{4}\right)(4-y)\right)\ dy = \int_0^4 \left( \frac{y^3}{4}-y^2-2y^{3/2}+8y^{1/2}\right)\ dy\\
